        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-8">
            ...
            <div class="main-carousel-wrapper my-1" v-if="showModal">
              ...
              <VueSlickCarousel  style="cursor: pointer" ref="c3" :asNavFor="c4" autoplay="true" v-bind="modalSettings" class="images-wrapper">
                <div v-for="img in lightboxPics" :key="img.img" @click="index = img.img" >
                  <img :src="img.img" alt="main-pic" class="main-carousel-wrapper__img image">
                </div>
            ...
            <div class="bg-dark indicator-wrapper">
              <div class="indicator-wrapper__within">
                <VueSlickCarousel ref="c4"  :asNavFor="c3" autoplay="true" :autoplaySpeed=5000 :speed="500" :slidesToShow="6" :focusOnSelect="true">
                  <div v-for="img,i in lightboxPics" :key="i" >
                    <img :src="img.img" alt="indicator-pic" class="indicator-carousel" style="cursor:pointer">
                  </div>
                </VueSlickCarousel>
              </div>
            </div>
